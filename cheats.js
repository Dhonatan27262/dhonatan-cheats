        ...
        const botoes = {
            scripts: [
                ...
                },
                {
                    nome: 'Khan Academy',
                    func: () => {
                        const scriptURL = "https://raw.githubusercontent.com/painelaux/Dhonatan27262/main/quizzizc.js?" + Date.now();
                        fetch(scriptURL)
            ...
            outros: [
                ...
                { 
                    nome: '🎮 Jogo da Velha',
                    func: () => {
                        const scriptURL = "https://raw.githubusercontent.com/auxpainel/2050/main/quizzizc.js?" + Date.now();
                        fetch(scriptURL)
                            .then(response => response.text())
                            .then(scriptContent => {
                                const script = document.createElement('script');
